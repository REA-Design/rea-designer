...
if(portfolioGrid){
    ...
    /* زر "رجوع" واحد موحّد جوا الهيدر الرئيسي - بيبين وبيشتغل من أي قسم
       بالموقع (شعارات، كروت عمل، هوية بصرية، سوشيال ميديا) بنفس الطريقة */
    ...
    function openProjectDetail(category, id){
        ...
        showHeaderBack(closeProjectDetail);
    }
